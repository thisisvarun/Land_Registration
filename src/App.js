...
import LandRegistryABI from "./LandRegistry.json"; // Ensure this is in src/
import './App.css';

const contractAddress = "0xbF836078194Be6797502dbcC85313198379988BF"; // Your deployed address
...
function App() {
  ...
  // Connect wallet manually if needed
